...
//
    ...
    @RequestMapping(method = RequestMethod.GET, path = "/secure/go-to-change-password")
    public String goChangePassword() {
        return CHANGE_PASSWORD;
    }

    @RequestMapping(method = RequestMethod.GET, path = "/secure/money")
    public String getTransferPage() {
        return CARD_SIGN_IN_PAGE;
    }
